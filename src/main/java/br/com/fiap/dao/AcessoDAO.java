...
public class AcessoDAO {
    ...
    public void insertAcessos(Acesso acesso) {
        try {
            Connection conn = factory.getConnection();
            PreparedStatement stmt = conn.prepareStatement("INSERT INTO cc_acessos_funcionalidade (id, funcionalidade, quantidade_acessos, tempo_permanencia_seg, data_acesso, id_paciente) VALUES (?, ?, ?, ?, ?, ?)");
